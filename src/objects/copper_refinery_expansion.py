...
SPRITE_FILE = "src/graphics/industries/copper_refinery_1.png"
CLASS_ID = "AXSH"
...
chimney = ExpansionObject(
    id="copper_refinery_exp_chimney",
    numeric_id=393,
    name_string="STR_OBJECT_COPPER_REFINERY_CHIMNEY",
    class_id=CLASS_ID,
...
building = ExpansionObject(
    id="copper_refinery_exp_building",
    numeric_id=394,
    name_string="STR_OBJECT_COPPER_REFINERY_BUILDING",
    class_id=CLASS_ID,
    class_name_string=CLASS_NAME,
    sprite_file=SPRITE_FILE,
