...
SPRITE_FILE = "src/graphics/industries/phosphate_mine_1.png"
CLASS_ID = "AXPM"
CLASS_NAME = "STR_OBJECT_CLASS_MINE_EXPANSIONS"

# 5x3 open pit — same sprite layout as bauxite, different PNG
pit = ExpansionObject(
    id="phosphate_exp_pit",
    numeric_id=249,
    name_string="STR_OBJECT_PHOSPHATE_PIT",
    class_id=CLASS_ID,
