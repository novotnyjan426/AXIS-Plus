...
SPRITE_FILE = "src/graphics/industries/integrated_steel_mill_1.png"
CLASS_ID = "AXSH"
...
furnace = ExpansionObject(
    id="integrated_steel_mill_exp_furnace",
    numeric_id=397,
    name_string="STR_OBJECT_INTEGRATED_STEEL_FURNACE",
    class_id=CLASS_ID,
...
building = ExpansionObject(
    id="integrated_steel_mill_exp_building",
    numeric_id=398,
    name_string="STR_OBJECT_INTEGRATED_STEEL_BUILDING",
    class_id=CLASS_ID,
    class_name_string=CLASS_NAME,
    sprite_file=SPRITE_FILE,
