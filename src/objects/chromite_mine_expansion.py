...
SPRITE_FILE = "src/graphics/industries/chromite_mine_1.png"
CLASS_ID = "AXPM"
CLASS_NAME = "STR_OBJECT_CLASS_MINE_EXPANSIONS"
GROUND = "2022"  # GROUNDTILE_MUD_TRACKS

headgear = ExpansionObject(
    id="chromite_exp_headgear",
    numeric_id=230,
    name_string="STR_OBJECT_CHROMITE_HEADGEAR",
    class_id=CLASS_ID,
...
winding_house = ExpansionObject(
    id="chromite_exp_winding_house",
    numeric_id=231,
    name_string="STR_OBJECT_CHROMITE_WINDING_HOUSE",
    class_id=CLASS_ID,
    class_name_string=CLASS_NAME,
    sprite_file=SPRITE_FILE,
...
exit_trestle = ExpansionObject(
    id="chromite_exp_exit_trestle",
    numeric_id=232,
    name_string="STR_OBJECT_CHROMITE_EXIT_TRESTLE",
    class_id=CLASS_ID,
    class_name_string=CLASS_NAME,
    sprite_file=SPRITE_FILE,
    animation_frames=[
...
ore_pile = ExpansionObject(
    id="chromite_exp_ore_pile",
    numeric_id=233,
    name_string="STR_OBJECT_CHROMITE_ORE_PILE",
    class_id=CLASS_ID,
    class_name_string=CLASS_NAME,
    sprite_file=SPRITE_FILE,
