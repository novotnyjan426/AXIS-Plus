...
SPRITE_FILE = "src/graphics/industries/tinplate_works_1.png"
CLASS_ID = "AXSH"
...
factory = ExpansionObject(
    id="tinplate_works_exp_factory",
    numeric_id=409,
    name_string="STR_OBJECT_TINPLATE_FACTORY",
    class_id=CLASS_ID,
...
shed = ExpansionObject(
    id="tinplate_works_exp_shed",
    numeric_id=410,
    name_string="STR_OBJECT_TINPLATE_SHED",
    class_id=CLASS_ID,
    class_name_string=CLASS_NAME,
    sprite_file=SPRITE_FILE,
    size=[1, 1],
